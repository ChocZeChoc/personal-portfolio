import './Home.css'
import profile from '/src/assets/img/Linkedin.jpg'

const Home = () => {
  return (
    <div className='homePage'>
    <div>
        <img src={profile} alt='profile pic' style={{maxHeight:'500px'}} className='profileimg'/>
    </div>
    <div className='homeIntro'>
        <h1>Hello I'm <span style={{color:'#6600cc'}}>Nathan</span></h1> 
        <h2>Cat Lover & Beetle Breeder</h2>
